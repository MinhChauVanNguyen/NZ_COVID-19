---
title: 'New Zealand''s fictitious COVID-19 data dashboard'
resource_files:
...
<div style="font-size:85%;">This bar chart displays the number of cases for each Ethnicity group at SA2 level within Districts/Cities (Input). Hover over each bar for more information.</div>
...
renderHighchart({
  ...
  cols <-  c('#2f7ed8', '#ff99cc', '#8bbc21', '#00cc99', '#1aadce',
        '#ff9966', '#ffff00', '#77a1e5', '#9999ff', '#a6c96a')
  ...
  if(isTRUE(input$style)){
    my_table <- return(as.datatable(
     ...
     caption = tags$caption(
        ...
        tags$span("*Rows highlighted in blue indicating the rates are extreme - more than 50 cases per 1000 persons-month.", style = "color:#33CCFF;font-size:85%;font-style:italic;")
        ),
     options = list(
